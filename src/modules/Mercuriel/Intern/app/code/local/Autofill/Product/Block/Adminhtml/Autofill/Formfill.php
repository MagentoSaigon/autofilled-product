 ...
 * Time: 14:23
 */
class Autofill_Product_Block_Adminhtml_Autofill_Formfill extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText(){
        ...
        return Mage::helper('autofill_product')->__('New Form Auto-Fill ');
    }
}